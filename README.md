...
<table>
  <tr>
    ...
    <td width="33%" valign="top">
      ...
      <p>Authentication pages connected with real APIs for login, register, refresh, and logout.</p>
      <p><b>Stack:</b> React, Vite, TypeScript</p>
      <p><b>Focus:</b> Clean UI, API wiring, token flow</p>
    </td>
  </tr>
</table>
...
Understand the real problem
  ↓
Design simple user flow
  ↓
Build clean frontend
  ↓
Connect reliable backend
  ↓
Store data properly
  ↓
...
<table>
  <tr>
    <td>🔥 Main stack</td>
    <td>React, TypeScript, ASP.NET Core, PostgreSQL</td>
  </tr>
  <tr>
    <td>📚 Learning</td>
  ...
  <tr>
    <td>🎯 Goal</td>
    <td>Build portfolio-level products that look good and work well</td>
  </tr>
  <tr>
    <td>🧩 Style</td>
    <td>Practical, curious, detail-oriented</td>
  </tr>
</table>

---

## ⚙️ EinsteinDavang.exe
